    ...
    BroadcastReceiver bluetoothMsgReceiver = new BroadcastReceiver() {//系统蓝牙广播接收
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action)){
                ...
                lv_devlist.setAdapter( new ArrayAdapter<>(BluetoothActivity.this, R.layout.main_listview_item, R.id.tv_main_listview_detail,findDevList));
                //Toast.makeText(MainActivity.this, "搜索到设备", Toast.LENGTH_SHORT).show();
            }else if(BluetoothAdapter.ACTION_DISCOVERY_FINISHED.equals(action)){
                Toast.makeText(BluetoothActivity.this, "搜索完毕:"+ findDevList.size(), Toast.LENGTH_SHORT).show();
            }
        }
    };
...
//        return;
        ...
        lv_binddevlist.setAdapter( new ArrayAdapter<>(BluetoothActivity.this, R.layout.main_listview_item, R.id.tv_main_listview_detail,bindDevList));
    }
    //开始搜索按钮
...
//        startActivityForResult(enable, 0);
    ...
    public void tv_main_listview_detail_onClick(View v){
        ...
        if (bluetoothDevice.getBondState() == BluetoothDevice.BOND_BONDED) {//已配对
            ...
            Toast.makeText(BluetoothActivity.this, "其他", Toast.LENGTH_SHORT).show();
        }
    }
    /**
     * 注册已绑定的蓝牙的设备列表的单击事件
